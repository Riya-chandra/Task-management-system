  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-3 mb-4 flex flex-col sm:flex-row gap-2">
      ...
      <Modal open={modalOpen} onClose={closeModal} title={editingTask ? 'Edit Task' : 'New Task'}>
        <TaskForm task={editingTask} onSuccess={handleFormSuccess} onCancel={closeModal} />
      </Modal>
